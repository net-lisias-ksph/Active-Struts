...
namespace ActiveStruts
{
    public class Config
    {
        ...
        public const string LinkHelpText = "Click left on a possible target to establish a link. Press 'x' to abort. You can alos right click -> 'Set as Target' on a valid target and right click -> 'Abort' on the targeter.";
